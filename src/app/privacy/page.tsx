    ...
    >
      <div className="flex flex-col gap-4">
        ...
        <p className={siteSectionDescriptionClass}>
          Last updated July 13, 2026. This page explains what we collect when you
          use jeenlabs.com.
        </p>
      </div>
      ...
      <div className="flex flex-col gap-6 text-sm leading-relaxed text-muted-foreground sm:text-base">
        ...
        <section className="flex flex-col gap-2">
          ...
          <p>
            If Google Analytics is configured for this deployment, it may collect
            standard usage metrics such as pages viewed and approximate location.
